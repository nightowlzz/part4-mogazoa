...
function CategoryTag({ categoryName, categoryId = 1 }: TagProps) {
  ...
  return (
    <div
      className={`flex items-center justify-self-center md:px-[0.625rem] px-2 py-1 md:h-[1.813rem] h-[1.375rem] w-fit rounded-lg text-xs md:text-lg ${textColorClass} ${bgColorClass}`}
    >
      {categoryName}
    </div>
  );
