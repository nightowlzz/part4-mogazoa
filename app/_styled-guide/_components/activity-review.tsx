...
export function ActivityReview({ reviewCount }: ActivityReviewProps) {
  return (
    <div className="flex flex-col items-center justify-center w-[105px] py-5 px-[21px] bg-black-500 rounded-xl border-black-400 md:w-[163px] lg:w-[300px] lg:px-[105px] lg:py-[30px]">
      ...
      <div className="flex items-center justify-center ">
        <Image
          ...
          width={20}
          height={20}
          className="mr-[5px] lg:w-[24px] lg:h-[24px]"
        />
